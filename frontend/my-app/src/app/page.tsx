...
export default function Home() {
  ...
  const processTextInput = async () => {
    ...
    try {
      ...
      await apiService.processTextQuery(textDescription, 'user-123');
      
      clearInterval(progressInterval);
      setProcessingProgress(100);
      
      // Mock recommendations based on text analysis
    ...
    try {
      ...
      mediaRecorder.onstop = async () => {
        ...
        await processVoiceInput(audioBlob);
            ...
            setIsProcessing(false);
            setCurrentStep(2); // Stay on voice recording step
          }
        } catch (error) {
  ...
  const processVoiceInput = async (audioBlob: Blob) => {
    ...
    try {
      ...
      reader.onloadend = async () => {
        ...
        // Call AI API for voice processing
        // Note: processVoiceQuery method needs to be added to apiService
        // await apiService.processVoiceQuery(base64Audio, 'user-123');
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-100">
      ...
      <main className="max-w-4xl mx-auto px-4 py-16 pt-20">
        ...
        <div className="mb-8">
          ...
          <div className="text-center mt-4">
            <h2 className="text-2xl font-bold text-gray-900 mb-2">
              {currentStep === 1 && 'Step 1: Choose Input Method'}
              {currentStep === 2 && (selectedOption === 'upload' ? 'Step 2: Upload Image' : selectedOption === 'text' ? 'Step 2: Describe Your Style' : 'Step 2: Voice Recording')}
              {currentStep === 3 && 'Step 3: AI Processing'}
              {currentStep === 4 && 'Step 4: Your Recommendations'}
            </h2>
            <p className="text-gray-600">
              {currentStep === 1 && 'Select how you want to describe your design preferences'}
              {currentStep === 2 && (selectedOption === 'upload' ? 'Upload a photo of your space for AI analysis' : selectedOption === 'text' ? 'Tell us about your style preferences in detail' : 'Record your design ideas naturally')}
              {currentStep === 3 && 'Our AI is analyzing your preferences'}
        ...
        <div className="bg-gradient-to-br from-white/80 to-white/60 backdrop-blur-sm rounded-3xl shadow-xl p-8 min-h-[500px] relative">
          ...
          {currentStep === 1 && (
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-8 max-w-md mx-auto">
                Select how you would like to describe your design preferences
              </p>
              
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                {/* Upload Image Option */}
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 hover:shadow-lg transition-all cursor-pointer" onClick={() => handleOptionClick('upload')}>
                ...
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                  ...
                  <p className="text-gray-600 text-sm">Show your room and get AI recommendations</p>
          </div>
          ...
          {/* Step 2: Upload Image */}
          {currentStep === 2 && selectedOption === 'upload' && (
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-8 max-w-md mx-auto">
                Upload a photo of your space for AI analysis
              </p>
              
              <div className="max-w-2xl mx-auto">
                <Link
                  href="/upload-manager"
                  className="w-full bg-gradient-to-r from-green-500 to-emerald-500 text-white py-4 rounded-2xl font-semibold text-lg hover:from-green-600 hover:to-emerald-600 transition-all shadow-lg hover:shadow-xl block"
                >
          ...
          {/* Step 2: Text Input */}
          {currentStep === 2 && selectedOption === 'text' && (
            <div className="text-center">
          ...
          {currentStep === 2 && selectedOption === 'voice' && (
            <div className="text-center">
              ...
              <div className="max-w-md mx-auto">
                <div className={`w-32 h-32 mx-auto rounded-full flex items-center justify-center mb-6 ${
                  isRecording ? 'bg-blue-500 animate-pulse' : 'bg-gradient-to-r from-sea-500 to-purple-500'
                }`}>
          ...
          {currentStep === 3 && (
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">AI Processing Your Request</h3>
              <p className="text-gray-600 mb-8">Our AI is analyzing your preferences to find perfect matches</p>
              ...
              <div className="mb-6">
                ...
                <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-2xl p-6">
                  ...
                  {processingProgress < 25 && "Analyzing your preferences..."}
                  {processingProgress >= 25 && processingProgress < 50 && "Finding matching styles..."}
                  {processingProgress >= 50 && processingProgress < 75 && "Generating recommendations..."}
          ...
          {/* Step 4: Results */}
          {currentStep === 4 && showResults && recommendations.length > 0 && (
            <div className="text-center">
              <div className="w-24 h-24 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full flex items-center justify-center mx-auto mb-6">
                <svg className="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Your Personalized Recommendations</h3>
              <p className="text-gray-600 mb-8">Based on your preferences, here are our top picks</p>
